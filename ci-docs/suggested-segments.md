---
title: Segmentos sugeridos (pré-visualização)
...
Enquanto utilizador do Customer Insights, é provável que tenha uma série de [medidas criadas](measures.md) que ajudam a controlar os seus Indicadores Chave de Desempenho (KPIs). É importante entender como certos atributos influenciam este KPI para criar segmentos e executar uma campanha altamente direcionada.   
...
Selecione um segmento sugerido para rever os detalhes dessa sugestão. Também pode rever os valores ou regras de atributos que o modelo de IA aprendeu para sugerir o segmento selecionado.

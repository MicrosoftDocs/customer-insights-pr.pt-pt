...
Os administradores podem configurar o Customer Insights para [utilizar um ambiente do Dataverse existente](create-environment.md) quando criam um ambiente do Customer Insights. Ao fornecer o URL para o ambiente do Dataverse, está a anexar ao respetivo ambiente do Customer Insights. Os ambientes do Customer Insights e do Dataverse têm de ser a hospedados na mesma região. 

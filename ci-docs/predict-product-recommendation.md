...
- O seu ambiente tem de ser configurado para a audiência de destino principal dos **consumidores individuais**.
...
1. No passo **Filtros de produtos**, escolha de entre as seguintes opções.

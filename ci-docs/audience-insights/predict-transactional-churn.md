...
> [!TIP]
> Experimente o tutorial para uma predição de abandono de transações utilizando dados de exemplo: [Guia de exemplo para a predição de abandono de transações](sample-guide-predict-transactional-churn.md).
...
1. Selecione o mosaico do **Modelo de abandono de clientes** e selecione **Utilizar este modelo**.

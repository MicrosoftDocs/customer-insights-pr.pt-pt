...
1. Se o campo for utilizado numa regra para registos duplicados ou condições de correspondência, execute os seguintes passos. Caso contrário, aceda ao passo seguinte.
